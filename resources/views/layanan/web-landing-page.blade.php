        ...
        <div class="max-w-6xl mx-auto px-5 md:px-6">
            ...
            <div class="mt-8 md:mt-10 text-center" data-aos="fade-up">
                ...
                <a href="https://wa.me/6285865405330?text={{ urlencode('Halo Cakra Inovasi Digital, saya ingin konsultasi landing page untuk campaign bisnis saya.' . $suffix) }}"
                    target="_blank" rel="noopener noreferrer"
                    class="btn-whatsapp-agen inline-flex items-center gap-2 text-blue-600 font-semibold hover:underline underline-offset-4 transition text-sm"
                    data-agent="CS Landing Page">
                ...
                <article
                    ...
                    <div class="p-6 md:p-8 flex-1 flex flex-col">
                        ...
                        <a href="https://wa.me/6285865405330?text={{ $p['wa_text'] }}" target="_blank"
                            ...
                            class="btn-whatsapp-agen mt-auto block w-full py-3 px-6 text-center rounded-sm font-body font-bold text-sm transition-colors {{ $p['btn_style'] }}" data-agent="CS Landing Page">
