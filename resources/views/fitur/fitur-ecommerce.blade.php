    ...
    <section class="pt-36 pb-14 bg-white">
        <div class="max-w-7xl mx-auto px-5 md:px-6">
            ...
            <div class="max-w-6xl mx-auto text-center mb-10">
                ...
                ['name' => 'E-Commerce',        'url' => url('/layanan/web-ecommerce')],
            ]" current="Fitur & Harga" />
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="overflow-x-auto rounded-3xl border border-slate-200 shadow-sm" data-aos="fade-up">
                <table class="w-full text-left border-collapse min-w-[680px] table-fixed">
                    {{-- Tambahkan table-fixed untuk kontrol lebar yang lebih baik --}}

                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-200">
                            {{-- Header Fitur: Diberi z-30 agar selalu di atas saat di-scroll --}}
                            <th class="py-6 px-5 w-[240px] sticky left-0 bg-slate-50 z-30 border-r border-slate-100">
                    ...
                    <tbody class="text-sm divide-y divide-slate-100">
                        ...
                        <tr class="bg-orange-50/60">
                            {{-- FIX: Gunakan sticky left-0 dan z-20 agar teks tetap muncul saat di-slide --}}
                            <td colspan="4" class="py-3 px-5 sticky left-0 z-20 bg-orange-50">
                                <span
                                    class="text-[11px] font-bold text-orange-600 uppercase tracking-widest sticky left-5">
                                    {{ $groupName }}
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            {{-- Label Fitur: Sticky left agar tetap terlihat saat slide ke kanan --}}
                            <td
                    ...
                    <tfoot>
                        <tr class="border-t-2 border-slate-100 bg-slate-50/50">
                            <td
                                class="py-7 px-5 sticky left-0 bg-slate-50 z-10 border-r border-slate-100 text-[10px] text-slate-400 italic">
                                *Harga belum termasuk domain/hosting perpanjangan.
                            </td>
                            @foreach($cols as $col)
                            <td class="py-7 px-5 text-center">
                                <a href="[https://wa.me/6285865405330?text=Halo%20Cakra%2C%20saya%20tertarik%20dengan%20](https://wa.me/6285865405330?text=Halo%20Cakra%2C%20saya%20tertarik%20dengan%20){{ $col['wa'] }}"
